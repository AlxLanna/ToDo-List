...
class ListaTarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lista_tarefa" do
    assert_difference("ListaTarefa.count") do
      post lista_tarefas_url, params: { lista_tarefa: { concluído: @lista_tarefa.concluído, descrição: @lista_tarefa.descrição, entrega: @lista_tarefa.entrega, tarefas: @lista_tarefa.tarefas } }
    end
  ...
  test "should update lista_tarefa" do
    patch lista_tarefa_url(@lista_tarefa), params: { lista_tarefa: { concluído: @lista_tarefa.concluído, descrição: @lista_tarefa.descrição, entrega: @lista_tarefa.entrega, tarefas: @lista_tarefa.tarefas } }
